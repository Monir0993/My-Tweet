        ...
        <div class="row ">
            ...
            <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="<?php echo base_url(); ?>Welcome/user_login_check" method="post" onsubmit="return validateStandard(this)">
                        <hr />
                        ...
                        <div class="form-group">
                            ...
                            <span class="pull-right">
                                <a href="<?php echo base_url(); ?>Registration/forget_password" >Forget password ? </a> 
                            </span>
                        </div>
                        ...
                        <input type="submit" id="sbtn" class="btn btn-primary" value="Login Now">
                        <hr />
